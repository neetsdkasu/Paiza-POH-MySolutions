...
void solve(MyIO *io) {
        ...
        NSInteger
            n = [[np objectAtIndex:0] integerValue],
            p = [[np objectAtIndex:1] integerValue],
            m = [[mq objectAtIndex:0] integerValue],
            q = [[mq objectAtIndex:1] integerValue];
        
        NSNumber
            *answer = [NSNumber numberWithInteger: n * p + (n / m + (n % m ? 1 : 0)) * q  ];
        
        [io write: [answer stringValue]];
        [io write: @"\n"];
